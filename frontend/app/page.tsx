    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-xl">Giáo Án Thông Minh</span>
          </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            Hệ thống AI đa tác tử tự động soạn giáo án theo chuẩn GDPT 2018. Giảm 96% thời gian soạn
            bài, chuẩn hóa 100% format, giảm 70% khối lượng review.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/login" className="btn-primary !py-4 !px-8 text-lg" id="hero-cta">
              🚀 Tạo giáo án ngay
            </Link>
            <a
              href="#features"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="glass rounded-2xl p-8 border border-white/10 card-hover">
      ...
      <section className="pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center glass rounded-3xl p-12 border border-white/10">
          <h2 className="text-3xl font-bold text-white mb-4">Sẵn sàng tiết kiệm thời gian?</h2>
          <p className="text-gray-400 mb-8">
            Bắt đầu soạn giáo án chỉ trong vài phút. Không cần cài đặt phức tạp.
          </p>

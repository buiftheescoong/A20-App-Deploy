...
export const MOCK_LESSON_PLAN: LessonPlanJSON = {
  ...
  sections: {
    engage: {
      ...
      content:
        'GV đưa ra tình huống thực tế về quãng đường đi được của một xe chuyển động thẳng đều. Yêu cầu HS thiết lập công thức tính quãng đường theo thời gian.',
      duration: 5,
    },
    explore: {
      title: 'Khám phá (Explore)',
      content:
        'HS quan sát các ví dụ về hàm số bậc nhất, thảo luận về điều kiện của hệ số a. HS thực hiện vẽ thử đồ thị dựa trên bảng giá trị.',
      duration: 10,
    },
    explain: {
      title: 'Giải thích (Explain)',
      content:
        'GV chính xác hóa khái niệm hàm số bậc nhất. Hướng dẫn các bước vẽ đồ thị (tìm 2 điểm cực trị hoặc 2 điểm bất kỳ).',
      duration: 15,
    },
    elaborate: {
      title: 'Vận dụng (Elaborate)',
      content:
        'HS thực hành vẽ đồ thị y = 2x + 1 và y = -x + 3. So sánh độ dốc của hai đường thẳng.',
      duration: 10,
    },
    evaluate: {
      title: 'Đánh giá (Evaluate)',
      content:
        'GV tổng kết bài học thông qua trò chơi trắc nghiệm ngắn trên phần mềm hoặc phiếu bài tập.',
      duration: 5,
    },
  },

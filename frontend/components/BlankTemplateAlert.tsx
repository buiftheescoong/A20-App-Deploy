...
export default function BlankTemplateAlert({
  taskId,
  onRetry,
}: BlankTemplateAlertProps) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-bold">
              Template trắng đã được chuẩn bị
            </h3>
      ...
      <div className="p-6 space-y-4">
        <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
          <p className="text-amber-800 text-sm leading-relaxed">
            Do lỗi kỹ thuật hoặc hết thời gian xử lý, chúng tôi đã chuẩn bị
            sẵn một <strong>template giáo án trắng</strong> theo đúng format
            chuẩn GDPT 2018. Bạn có thể tải về và tự điền nội dung.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          ...
          <ul className="text-sm text-gray-600 space-y-1.5">
            ...
            <li className="flex items-start gap-2">
              <span>4️⃣</span>
              <span>
                Quay lại đây để kiểm tra compliance khi đã hoàn thành
              </span>
            </li>
          </ul>
        </div>
